...
export default function FinalizarOrdenModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await trabajoAPI.finalizar(trabajo.id, payload);
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                placeholder="Describe el cierre del trabajo, hallazgos finales o recomendaciones..."
                className="w-full resize-y px-4 py-3 border border-gray-300 rounded-lg text-sm
                       focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent
                       transition-all duration-200 placeholder:text-gray-400"
              />
              <p className="text-xs text-gray-500 mt-2">
                Este texto se guardará en las observaciones de la orden de trabajo.
              </p>
            </div>
