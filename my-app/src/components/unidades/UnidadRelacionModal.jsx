  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/30" onClick={onClose}>
      <div className="flex min-h-full items-start justify-center px-4 py-4 sm:items-center">
        <div
          className="flex max-h-[calc(100dvh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-xl bg-white shadow-xl sm:max-h-[calc(100dvh-4rem)]"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="flex items-start justify-between border-b border-gray-200 px-6 py-5">
            <div>
              <h2 className="text-lg font-semibold text-[#1e3a8a]">Relacionar unidades</h2>
          ...
          <div className="mt-4 flex-1 overflow-y-auto px-6 pb-1">
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <select
                ...
                onChange={(e) => onChange({ ...form, unidad_relacionada: e.target.value })}
                disabled={!form.dimension}
              >
